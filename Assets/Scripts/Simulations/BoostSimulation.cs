    ...
    private void Update() // Se ejecuta cada frame
    {
        foreach (Bolita bolita in SimulationManager.Todas) // Itera sobre todas las bolitas registradas en el SimulationManager
        {
            ...
            Vector3 impulso =
                ...
                fuerzaImpulso; // Calcula el vector de impulso normalizando la direcci�n y multiplic�ndola por la fuerza

            bolita.AgregarImpulso(impulso); // Aplica el impulso a la bolita utilizando su m�todo AgregarImpulso
        }
    }
